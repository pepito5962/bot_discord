var xml12json = require("xmljson");
var querystring = require("querystring");

var app = {
  httpProtocol: "https", // http, https
  timeout: 5000, // max execution time (milliseconds)
  developerKey: "RGAPI-30af2993-ccb3-4036-b12e-9f4a705559af", // Riot API Key
};
...
app.champion = {
  ...
  all: function (vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v1.2/champion",
      vars,
      cb,
      app.settings.region
    );
  ...
  id: function (id, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v1.2/champion/" + id,
      vars,
      cb,
      app.settings.region
    );
...
app.league = {
  ...
  byTeam: function (teamIds, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.5/league/by-team/" + teamIds,
      vars,
      cb,
      app.settings.region
    );
  ...
  challenger: function (vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.5/league/challenger",
      vars,
      cb,
      app.settings.region
    );
...
app.staticData = {
  ...
  champions: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/champion",
      vars,
      cb,
      app.settings.region
    );
  ...
  item: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/item",
      vars,
      cb,
      app.settings.region
    );
  ...
  itemId: function (itemId, vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/item/" + itemId,
      vars,
      cb,
      app.settings.region
    );
  ...
  languages: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/languages",
      vars,
      cb,
      app.settings.region
    );
  ...
  mastery: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/mastery",
      vars,
      cb,
      app.settings.region
    );
  ...
  realm: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/realm",
      vars,
      cb,
      app.settings.region
    );
  ...
  rune: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/rune",
      vars,
      cb,
      app.settings.region
    );
  ...
  runeId: function (runeId, vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/rune/" + runeId,
      vars,
      cb,
      app.settings.region
    );
  ...
  summonerSpell: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/summoner-spell",
      vars,
      cb,
      app.settings.region
    );
  ...
  versions: function (vars, cb) {
    app.talk(
      "api/lol/static-data/" + app.settings.region + "/v1.2/versions",
      vars,
      cb,
      app.settings.region
    );
      ...
      request.on("response", function (response) {
        ...
        response.on("end", function () {
          ...
          if (data.match(/^(\{.*\}|\[.*\])$/)) {
            ...
            data.match(/^<errors .+<\/errors>$/) ||
            data.match(/^<\?xml version.+<\/errors>$/)
          ) {
            // xml error response
          ...
          if (error && error.origin === "api" && error.message === "error") {
            ...
            if (
              ...
              error.details[0] &&
              error.details[0].internalReason ===
...
app.match = {
  ...
  match: function (matchId, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.2/match/" + matchId,
      vars,
      cb,
      app.settings.region
    );
...
app.matchHistory = {
  ...
  matchHistory: function (summonerId, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.2/matchhistory/" + summonerId,
      vars,
      cb,
      app.settings.region
    );
...
app.summoner = {
  ...
  summonerIds: function (summonerIds, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v1.4/summoner/" + summonerIds,
      vars,
      cb,
      app.settings.region
    );
...
app.team = {
  ...
  bySummoner: function (summonerId, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.4/team/by-summoner/" + summonerId,
      vars,
      cb,
      app.settings.region
    );
  ...
  teamIds: function (teamIds, vars, cb) {
    app.talk(
      "api/lol/" + app.settings.region + "/v2.4/team/" + teamIds,
      vars,
      cb,
      app.settings.region
    );
  ...
  request.on("response", function (response) {
    ...
    response.on("end", function () {
      ...
      if (data.match(/^(\{.*\}|\[.*\])$/)) {
        ...
        error.origin = "api";
        error.details =
          data.errors.error !== undefined ? [data.errors.error] : data.errors;
